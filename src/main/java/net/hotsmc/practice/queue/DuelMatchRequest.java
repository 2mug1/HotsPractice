...
@Getter
public class DuelMatchRequest extends DuelRequest {

    private PracticePlayer sender;
    private PracticePlayer me;

    public DuelMatchRequest(LadderType ladderType, PracticePlayer sender, PracticePlayer me) {
        super(ladderType);
        this.sender = sender;
        this.me = me;
    }
    ...
    @Override
    public void accept() {
        me.getDuelMatchRequests().remove(me.getDuelGameRequestBySender(sender));
